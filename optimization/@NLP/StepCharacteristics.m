...
if nlp.Problem.ForwardWalkingSpeed.Bool %for single support phase only
    [nlp] = AddConstraint(nlp, nlp.Problem.StepLength.Function(grid_var.(['pos_', num2str(nlp.Settings.ncp)]))/(grid_var.tf-grid_var.tf1), nlp.Problem.ForwardWalkingSpeed.LowerBound, nlp.Problem.ForwardWalkingSpeed.UpperBound, 'walking speed');        
end
