...
[obj, var_grid] = AddOriginalPosSwingLeg(obj, rbm, var_grid);
...
%[obj] = SecondStanceFootInitialVelocity(obj, rbm, var_grid);

[obj] = OneStepPeriodic(obj, rbm, var_grid);

[obj] = SwingFootImpactVelocities(obj, rbm, var_grid);

[obj] = AddGroundDeformation(obj, rbm, var_grid);

[obj] = SwingFootVelocityMiddle(obj, rbm, var_grid);
%% Parse Trajectory
...
for idx_fe = 1:obj.Settings.nfe
    ...
    switch obj.Settings.CollocationScheme
        ...
        case 'Trapezoidal'
            ...
            %[idx_fe, idx_fe+1]
            if idx_fe<=round((obj.Settings.nfe+1)/2) %%%%%%%%%%%%%%%%%%%%%%%%%%%
                PhaseEndTime=var_grid.tf1;            %time period for double support phase (phase 1)
                h = T/round((obj.Settings.nfe+1)/2);
            else
                PhaseEndTime=var_grid.tf-var_grid.tf1; %time period for single support phase (phase 2)
                h = T/(obj.Settings.nfe+1-round((obj.Settings.nfe+1)/2));
            end
            ...
            f1 = PhaseEndTime*[var_grid.(['vel_', num2str(idx1)]); var_grid.(['acc_', num2str(idx1)])];
            f2 = PhaseEndTime*[var_grid.(['vel_', num2str(idx2)]); var_grid.(['acc_', num2str(idx2)])];
            ...
            if obj.Problem.SlewRate.Bool
                ...
                du1 = PhaseEndTime*var_grid.(['der_input_', num2str(idx1)]);
                du2 = PhaseEndTime*var_grid.(['der_input_', num2str(idx2)]);
        ...
        case 'HermiteSimpson'
            ...
            f1 = PhaseEndTime*[var_grid.(['vel_', num2str(idx1)]); var_grid.(['acc_', num2str(idx1)])];
            f2 = PhaseEndTime*[var_grid.(['vel_', num2str(idx2)]); var_grid.(['acc_', num2str(idx2)])];
            f3 = PhaseEndTime*[var_grid.(['vel_', num2str(idx3)]); var_grid.(['acc_', num2str(idx3)])];
            ...
            if obj.Problem.SlewRate.Bool
                ...
                du1 = PhaseEndTime*var_grid.(['der_input_', num2str(idx1)]);
                du2 = PhaseEndTime*var_grid.(['der_input_', num2str(idx2)]);
                du3 = PhaseEndTime*var_grid.(['der_input_', num2str(idx3)]);
